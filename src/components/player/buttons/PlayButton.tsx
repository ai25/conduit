...
export function PlayButton(props: PlayButtonProps) {
  return (
    <Tooltip
      ...
      triggerSlot={
        <media-play-button class="ring-primary relative inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-md outline-none ring-inset hover:bg-white/20 data-[focus]:ring-4">
