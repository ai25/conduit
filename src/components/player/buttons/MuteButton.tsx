...
export function MuteButton(props: MuteButtonProps) {
  return (
    <Tooltip
      ...
      triggerSlot={
        <media-mute-button class="ring-primary group relative -mr-1.5 inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-md outline-none ring-inset hover:bg-white/20 data-[focus]:ring-4">
          <media-icon
