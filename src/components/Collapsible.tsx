...
export default function Collapsible(props: CollapsibleProps) {
  return (
    <KobalteCollapsible class={props.class}>
      ...
      <KobalteCollapsible.Content class="w-full animate-out fade-out slide-out-to-top-5 data-[expanded]:animate-in data-[expanded]:fade-in data-[expanded]:slide-in-from-top-5">
        {props.children}
