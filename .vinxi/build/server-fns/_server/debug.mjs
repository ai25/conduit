import{ssr as $,ssrHydrationKey as q,isServer as e}from"solid-js/web";import{createSignal as t,createEffect as z}from"solid-js";import{E as G,Y as J,Z as Q}from"./Toast.mjs";import"./Link.mjs";import"./index5.mjs";import"./index2.mjs";import"y-webrtc";import"yjs";import"solid-js/store";import"lib0/observable";import"numeral";import"@solid-primitives/date";import"./index4.mjs";import"./routing.mjs";import"./components.mjs";var V=["<div",' class="p-4"><h1 class="text-2xl font-bold">Debug</h1><div class="flex flex-col space-y-2"><div class="flex flex-col space-y-1"><div class="flex flex-row justify-between"><div class="font-bold">Web Worker</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">OPFS</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">WebRTC</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">Service Worker</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">Service Worker Enabled</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">Locks</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">Persistent Storage</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">Persistent Storage Enabled</div><div>','</div><span class="cursor-pointer underline text-primary">Enable</span></div><div class="flex flex-row justify-between"><div class="font-bold">Create Sync Access Handle</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">Message Channel</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">Broadcast Channel</div><div>','</div></div><div class="flex flex-row justify-between"><div class="font-bold">Shared Service</div><div>',"</div></div></div></div></div>"];function ue(){G();const c=()=>e?!1:typeof Worker<"u",f=async()=>{if(e)return!1;try{return await navigator.storage.getDirectory(),!0}catch{return!1}},p=async()=>{if(e)return!1;try{return await navigator.mediaDevices.getUserMedia({audio:!0}),!0}catch{return!1}},v=()=>e?!1:typeof navigator.serviceWorker<"u",u=async()=>e?!1:await fetch("/clientId").then(r=>r.ok),S=()=>e?!1:typeof navigator.locks<"u",g=()=>e?!1:typeof navigator.storage.persist<"u",w=async()=>e?!1:await navigator.storage.persisted(),b=()=>e?!1:typeof MessageChannel<"u",y=()=>e?!1:typeof BroadcastChannel<"u",x=async()=>{if(e)return!1;const r=`
